...
local function run(msg,matches)
    ...
    local keyboard = '{"inline_keyboard":[[{"text":"'..link_text..'","url":"'..link..'"}],[{"text":"ورود به کانال اسمارت","url":"https://telegram.me/joinchat/C1p2TT-Hu-1gQlEzwiNZ_Q"}],[{"text":"تماس با ما","url":"http://telegram.me/AliE1_BOT"},{"text":"ورود به سایت","url":"http://test.ir"}]]}' --به دلخواه متن ها را تغییر دهید    
