-- طریقه فعال سازی کیبورد شیشه ای در کانال
-- ابتدا یک ربات در 
-- @BotFather
-- بسازید و ربات ساخته شده را در کانال مورد نظر ادمین کنید سپس توکن بات را در جای مشخص شده کپی کنید
-- ادامه توضیحات پایین زده شده
...
-- ساخته شده توسط کارول
-- فیکس شده توسط علی عبادی
