...
local function run(msg,matches)
    ...
    local url = 'https://api.telegram.org/bot'..api_key..'/sendMessage?chat_id=@smartgp&parse_mode=Markdown&text='..text..'&disable_web_page_preview=true&reply_markup='..keyboard..'
