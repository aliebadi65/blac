...
--endif--
  if value then
   ...
   text = '[ '..name..' ] \n شما اخطار دارید  !\nNتعداد اخطار به شما2/4'
   elseif value == '2' then
  redis:hset(hash, msg.from.id, '3')
  text = '[ '..name..' ] \n شما اخطار دارید  !\nNتعداد اخطار به شما 3/4'
   elseif value == '3' then
   redis:hdel(hash, msg.from.id, '0')
  text = '[ '..name..' ] \nشما اخطار دارید و حذف شدید  !\nتعداد اخطار به شما  4\4'
  local hash =  'banned:'..target
